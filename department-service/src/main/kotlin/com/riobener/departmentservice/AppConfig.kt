package com.riobener.departmentservice
...
class AppConfig {
    ...
    fun initTracer(): Tracer {
        ...
        return io.jaegertracing.Configuration.fromEnv("department-service").withSampler(samplerConfig).withReporter(reporter).tracer
    }
}